...
if st.button('Fetch and Process'):
    ...
    exporter_api_url = f"https://webservice.aws.medienhaus.net/tts-service/api/export/trigger/{article_id}/"
    
    exporter_auth_token = exporter_auth_token = st.secrets["api_tokens"]["exporter_auth_token"]
    headers_exporter = {
    ...
    if exporter_response.status_code != 200:
        ...
        openai_token = openai_token = st.secrets["api_tokens"]["openai_token"]
        headers_openai = {
